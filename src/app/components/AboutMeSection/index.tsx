        ...
        <div className={styles.aboutMeWrapper} id="aboutMe">
            <div className={`${styles.aboutMeContainer} container`}>
                ...
                <p className={styles.aboutMeText}>
                    I am <b>Beatriz Carvalho</b>, with 29 years old currently living in state of São Paulo - Brazil. <b>Frontend Developer</b>, working professionally as a developer since 2022.
                    <br />
                    <br />
